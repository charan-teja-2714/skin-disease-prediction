...
class SkinDiseasePredictor:
    ...
    def load_models(self):
        ...
        if os.path.exists('models/classification/efficientnet_masked.pth'):
            self.cls_model = EfficientNetClassifier().to(self.device)
            self.cls_model.load_state_dict(
                torch.load('models/classification/efficientnet_masked.pth', 
    ...
    def predict_image(self, image_path):
        ...
        if self.cls_model:
            ...
            with torch.no_grad():
                ...
                cls_pred = cls_output.argmax(1).item()
    ...
    def visualize_results(self, image, results, image_path):
        ...
        if 'segmentation' in results:
            ...
            mask_colored[:, :, 0] = seg_result['mask'] * 255  # Red channel
